    ...
    <div className="flex flex-col bg-gray-200 mt-10 p-10 md:p-20 text-center md:text-left">
      ...
      <div className="flex md:flex-row w-full md:mt-24 mt-12 md:gap-10 gap-6 flex-col">
        <div className="">
          ...
          <h2 className="text-2xl">Online Banking</h2>
          <br />
          <p className="">
        ...
        <div className="">
          ...
          <h2 className="text-2xl">Simple Budgeting</h2>
          <br />
          <p className="">
        ...
        <div className="">
          ...
          <h2 className="text-2xl">Fast Onboarding</h2>
          <br />
          <p className="">
        ...
        <div className="">
          ...
          <h2 className="text-2xl">Open API</h2>
          <br />
          <p className="">
